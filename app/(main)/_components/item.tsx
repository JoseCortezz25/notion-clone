...
export const Item = ({
  ...
  return (
    ...
    >
      ...
      {documentIcon ? (
        <div className="shrink-0 mr-2 h-[18px]" >
          {documentIcon}
        </div>
      ) : (
      ...
      {isSearch && (
        <kbd className="ml-auto pointer-events-none inline-flex h-5 selector-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">
